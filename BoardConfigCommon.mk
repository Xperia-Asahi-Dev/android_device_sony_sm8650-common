...
BOARD_VENDOR_RAMDISK_KERNEL_MODULES_LOAD := $(strip $(shell cat $(TARGET_KERNEL_SOURCE)/modules.vendor_boot.list.msm.pineapple))
BOARD_VENDOR_RAMDISK_RECOVERY_KERNEL_MODULES_LOAD := $(strip $(shell cat $(TARGET_KERNEL_SOURCE)/modules.recovery.list.msm.pineapple))
...
# fpc shit to be checked (leftover from sm6xxx device?)

TARGET_KERNEL_EXT_MODULES += \
    semc/hardware/camera-kernel-module/camera_sync:kbuild \
    semc/hardware/camera-kernel-module/hdmi_detect:kbuild \
    semc/hardware/camera-kernel-module/slg51000_regulator:kbuild \
    semc/hardware/camera-kernel-module/sony_camera:kbuild \
    semc/hardware/charge/kernel-modules/battchg_ext:kbuild \
    semc/hardware/charge/kernel-modules/battman_dbg:kbuild \
    semc/hardware/fingerprint/kernel-module/egis/et6xx:kbuild \
    semc/hardware/kernel-modules/msm/lxs_ts:kbuild \
    semc/ramdump/kernel-modules/last_logs:kbuild \
    semc/ramdump/kernel-modules/powerkey_forcecrash:kbuild \
    semc/ramdump/kernel-modules/ramdump_mem_desc:kbuild \
    semc/ramdump/kernel-modules/rdtags:kbuild
